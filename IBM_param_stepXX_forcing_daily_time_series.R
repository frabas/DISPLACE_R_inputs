...
a_ts <- read.table(file=file.path('C:','Users','fbas','Documents','GitHub','DISPLACE_input', 'timeseries', 'fishprice-all_area-0.dat'), header=FALSE)
plot(as.numeric(as.character(a_ts[-c(1:3),1])), type="l")
abline(h=a_ts[1,1], col=2)
abline(h=a_ts[2,1], col=2)

a_ts <- read.table(file=file.path('C:','Users','fbas','Documents','GitHub','DISPLACE_input', 'timeseries', 'fishprice-all_area-10.dat'), header=FALSE)
plot(as.numeric(as.character(a_ts[-c(1:3),1])), type="l")
abline(h=a_ts[1,1], col=2)
abline(h=a_ts[2,1], col=2)

a_ts <- read.table(file=file.path('C:','Users','fbas','Documents','GitHub','DISPLACE_input', 'timeseries', 'fishprice-all_area-11.dat'), header=FALSE)
plot(as.numeric(as.character(a_ts[-c(1:3),1])), type="l")
abline(h=a_ts[1,1], col=2)
abline(h=a_ts[2,1], col=2)
